//package com.example.plant_monitor.activities;
//
...
//        {
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new HomeView()).commit();
...
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new BloodInfo()).commit();
//        }
//        if (id == R.id.devinfo) {
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new AboutUs()).commit();
//        }
//
...
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new AchievmentsView()).commit();
//
//        }
...
//
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new SearchDonorFragment()).commit();
//
//        } else if (id == R.id.nearby_hospital) {
//            getFragmentManager().beginTransaction().replace(R.id.fragmentcontainer, new NearByHospitalActivity()).commit();
//
//        }
//
//        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
